        ...
        <div>
            <nav className="navbar navbar-expand-lg navbar-dark bg-dark">
                <div className="container">
                    <Link className="navbar-brand me-5" to="/home">Sagar's Carport</Link>
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            {user?.email &&
                                <li className="nav-item">
                                    <Link className="nav-link me-3" aria-current="page" to="/dashboard">Dashboard</Link>
                                </li>
                            }
                            <li className="nav-item">
                                <Link className="nav-link me-3" aria-current="page" to="/explorecars">Explore Cars</Link>
                            </li>
                            <li className="nav-item">
                                <Link className="nav-link me-3" aria-current="page" to="/reviews">Reviews</Link>
                            </li>
                            <li className="nav-item">
                                <Link className="nav-link me-3" aria-current="page" to="/writereview">Write A Review</Link>
                            </li>
